...
class BActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityAactivityBinding.apply {
            ...
            tvTop.text = this@BActivity::class.java.simpleName.substring(
                0, 1
            ) + " " + this@BActivity::class.java.simpleName.substring(1)
            activityAactivityBinding.apply {
            ...
            firstBtn.setOnClickListener {
                ...
                if (checkBoxB.isChecked) {
                    startActivity(Intent(this@BActivity, BActivity::class.java))
                }
            }
            secondBtn.setOnClickListener {
                if (checkBoxA.isChecked) {
                    val intent = Intent(this@BActivity, AActivity::class.java).apply {
                        flags = Intent.FLAG_ACTIVITY_SINGLE_TOP
                    }
                    startActivity(intent)
                }
                if (checkBoxB.isChecked) {
                    val intent = Intent(this@BActivity, BActivity::class.java).apply {
                        flags = Intent.FLAG_ACTIVITY_SINGLE_TOP
                    }
                    startActivity(intent)
                }
            ...
            fourthBtn.setOnClickListener {
                startActivity(Intent(this@BActivity, DActivity::class.java))
            }
        }
    }
