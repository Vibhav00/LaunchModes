...
class CActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityAactivityBinding.apply {
            ...
            tvTop.text = this@CActivity::class.java.simpleName.substring(
                0,
                1
            ) + " " + this@CActivity::class.java.simpleName.substring(1)
            activityAactivityBinding.apply {
            ...
            firstBtn.setOnClickListener {
                if (checkBoxA.isChecked) {
                    startActivity(Intent(this@CActivity, AActivity::class.java))
                }
                if (checkBoxB.isChecked) {
                    startActivity(Intent(this@CActivity, BActivity::class.java))
                }
            }
            secondBtn.setOnClickListener {
                if (checkBoxA.isChecked) {
                    val intent = Intent(this@CActivity, AActivity::class.java).apply {
                        flags = Intent.FLAG_ACTIVITY_SINGLE_TOP
                    }
                    startActivity(intent)
                }
                if (checkBoxB.isChecked) {
                    val intent = Intent(this@CActivity, BActivity::class.java).apply {
                        flags = Intent.FLAG_ACTIVITY_SINGLE_TOP
                    }
                    startActivity(intent)
                }
            ...
            thirdBtn.setOnClickListener {
                startActivity(Intent(this@CActivity, CActivity::class.java))
            }
            fourthBtn.setOnClickListener {
                startActivity(Intent(this@CActivity, DActivity::class.java))
            }
        }
    }
